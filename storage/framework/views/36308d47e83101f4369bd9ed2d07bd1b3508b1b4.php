    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username">Vương Đức Hiếu</span>
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
                <li><a href="#"><i class=" fa fa-suitcase"></i>Thông tin cá nhân</a></li>
                <li><a href="#"><i class="fa fa-cog"></i> Cài đặt</a></li>
                <li><a href="<?php echo e(route('logout')); ?>"><i class="fa fa-key"></i> Đăng xuất</a></li>
            </ul>
        </li>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="<?php echo e(route('getdashboard')); ?>">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="<?php echo e(route('add_category')); ?>">Thêm danh mục sản phẩm</a></li>
						<li><a href="<?php echo e(route('all_category')); ?>">Danh sách danh mục sản phẩm</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="<?php echo e(route('add_brand')); ?>">Thêm thương hiệu sản phẩm</a></li>
						<li><a href="<?php echo e(route('all_brand')); ?>">Danh sách thương hiệu sản phẩm</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="<?php echo e(route('add_product')); ?>">Thêm sản phẩm</a></li>
						<li><a href="<?php echo e(route('all_product')); ?>">Danh sách sản phẩm</a></li>
                    </ul>
                </li>
                <li>
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2021 Visitors. All rights reserved | Design by <a href="vuongduchieu ">W3layouts</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
...
<!-- calendar -->
	<script type="<?php echo e(asset('backend/text/javascript')); ?>" src="js/monthly.js"></script>
	<script type="<?php echo e(asset('backend/text/javascript')); ?>">
...
<?php /**PATH C:\wamp64\www\shoplaravel\resources\views/admin/admin_dashboard.blade.php ENDPATH**/ ?>